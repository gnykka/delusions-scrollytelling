document.addEventListener('DOMContentLoaded', () => {
  ...
  const onScroll = () => {
    ...
    const phase4 = texts[2].getBoundingClientRect().top + height * 0.3 <= 0;
    const phase5 = texts[2].getBoundingClientRect().top + height * 0.6 <= 0;
    const phase6 = texts[2].getBoundingClientRect().top + height * 0.9 <= 0;
...
// третий абзац: phase3 (голова), phase4 (змеи), phase5 (обезьяны), phase6 (рука)
